...
public class UnsplashImageView: UIImageView {
    @IBInspectable public var accessKey: String = "i6e5o20H3EROgmcZYuzIRAuHOuiVeUN7IP_R9EWHhEA"
    @IBInspectable public var query: String = "life age"
    var imageURL: URL?
    ...
    private func fetchImage(with url: URL) {
        ...
        imageDataTask = URLSession.shared.dataTask(with: url) { [weak self] (data, response, error) in
            ...
            DispatchQueue.main.async {
                UIView.transition(with: strongSelf, duration: 3, options: [.transitionCrossDissolve], animations: {
